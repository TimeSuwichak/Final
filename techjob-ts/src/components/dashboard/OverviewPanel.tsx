    ...
    <div className="space-y-8">
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-slate-800">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">แนวโน้มงานที่เข้ามา</h3>
          <div className="h-64">
      ...
      <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <KpiCard title="งานกำลังดำเนินการ" numericValue={85} icon={<Clock size={22} />} color="blue" change="+1.2% จากเดือนที่แล้ว" />
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-slate-800">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">สถิติงาน (Job Type Statistics)</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
