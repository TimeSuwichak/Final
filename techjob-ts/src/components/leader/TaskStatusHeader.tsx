...
const TaskStatusHeroRich: React.FC = () => {
  return (
    <div className="w-full p-6">
       ...
       {/* *** ปรับปรุง: Grid layout ใหม่สำหรับ 5 Card (lg:grid-cols-5) *** */}
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5"> 
          ...
          <div className="relative bg-white dark:bg-[#1e1e2d] p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-all flex flex-col justify-between overflow-hidden group cursor-pointer h-full">
...
<div className="relative bg-white dark:bg-[#1e1e2d] p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-all flex flex-col justify-between overflow-hidden group cursor-pointer h-full">
          ...
          {/* Card 5 (ใหม่): ตรวจสอบเสร็จสิ้น (Completed/Done) */}
